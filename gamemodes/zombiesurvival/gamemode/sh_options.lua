...
GM:AddStartingItem("sykov",				ITEMCAT_GUNS,			45,				"mg_makarov")
...
GM:AddPointShopItem("sykov",			ITEMCAT_GUNS,			15,				"mg_makarov", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("mg_makarov") end)

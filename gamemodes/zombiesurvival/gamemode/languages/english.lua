...
LANGUAGE.char_page_grid								= "Grid"
LANGUAGE.char_page_scars							= "Scars"
LANGUAGE.grid_tree_vitality							= "Vitality"
...
LANGUAGE.scar_zero_desc								= "Human last hits as a zombie."
LANGUAGE.scar_zero_effect							= "On kill: a short haste for allied undead."
...
LANGUAGE.wep_cwknife_desc							= "A service knife. Issued with the kit: it reaches the one in the doorway, not the one behind him."

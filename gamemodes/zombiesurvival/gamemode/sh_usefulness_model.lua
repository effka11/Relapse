...
GM.RelapseWeapons = {
	...
	mg_sbeta = {
		...
		PreviewIcon = "zombiesurvival/killicons/weapon_zs_mk2_side2.png",
		PreviewBoneMerge = true,
		PreviewHullBounds = true,
		PreviewParts = {
	...
	mg_akilo47 = {
		...
		PreviewIcon = "zombiesurvival/killicons/weapon_zs_ak47_side.png",
		PreviewBoneMerge = true,
		PreviewHullBounds = true,
		PreviewParts = {
	...
	mg_valpha = {
		...
		PreviewIcon = "zombiesurvival/killicons/weapon_zs_asval_side.png",
		PreviewBoneMerge = true,
		PreviewHullBounds = true,
		PreviewParts = {
	...
	mg_scharlie = {
		...
		PreviewIcon = "zombiesurvival/killicons/weapon_zs_scar_side.png",
		PreviewBoneMerge = true,
		PreviewHullBounds = true,
		PreviewParts = {
	...
	mg_alpha50 = {
		...
		PreviewIcon = "zombiesurvival/killicons/weapon_zs_ax50_side2.png",
		PreviewBoneMerge = true,
		PreviewHullBounds = true,
		PreviewParts = {
	...
	mg_smgolf45 = {
		...
		PreviewIcon = "zombiesurvival/killicons/weapon_zs_ump45_side2.png",
		PreviewBoneMerge = true,
		PreviewHullBounds = true,
	...
	mg_mpapa5 = {
		...
		PreviewIcon = "zombiesurvival/killicons/weapon_zs_mp5_side6.png",
		PreviewBoneMerge = true,
		PreviewHullBounds = true,
		PreviewBodygroups = { [0] = 1 },
		PreviewParts = {

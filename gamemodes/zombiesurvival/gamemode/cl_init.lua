...
function GM:DrawFearMeter(screenscale)
	if not (self:GetUseSigils() and self.MaxSigils > 0) then return end

	local size = 192 * screenscale
	local half_size = size / 2
	local mx, my = ScrW() / 2 - half_size, ScrH() - size
...
-- All HUD/UI text is created below. `font` is the TTF family name,
-- `weight` is 400 Regular / 500 Medium / 700 Bold. Outline makes Manrope look bloated.
local fontfamily = "Manrope"
local fontfamilysm = "Manrope"
local fontfamily3d = "Manrope"
local fontsizeadd = 0
local fontweight = 500
local fontweightbody = 400

function GM:Create3DFonts()
	local fontsizeadd3D = 0
	local fontweight3D = 500

	surface.CreateLegacyFont(fontfamily3d, 28 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFontSmaller", true, false)
	surface.CreateLegacyFont(fontfamily3d, 48 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFontSmall", true, false)
	surface.CreateLegacyFont(fontfamily3d, 72 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFont", true, false)
	surface.CreateLegacyFont(fontfamily3d, 128 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFontBig", true, false)
	surface.CreateLegacyFont(fontfamily3d, 28 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFontSmallerBlur", false, false, 16)
	surface.CreateLegacyFont(fontfamily3d, 48 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFontSmallBlur", false, false, 16)
	surface.CreateLegacyFont(fontfamily3d, 72 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFontBlur", false, false, 16)
	surface.CreateLegacyFont(fontfamily3d, 128 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFontBigBlur", false, false, 16)
	surface.CreateLegacyFont(fontfamily, 40 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFont2Smaller", true, false)
	surface.CreateLegacyFont(fontfamily, 48 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFont2Small", true, false)
	surface.CreateLegacyFont(fontfamily, 72 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFont2", true, false)
	surface.CreateLegacyFont(fontfamily, 128 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFont2Big", true, false)
	surface.CreateLegacyFont(fontfamily, 40 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFont2SmallerBlur", false, false, 16)
	surface.CreateLegacyFont(fontfamily, 48 + fontsizeadd3D, fontweight3D, true, false,  "ZS3D2DFont2SmallBlur", false, false, 16)
	surface.CreateLegacyFont(fontfamily, 72 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFont2Blur", false, false, 16)
	surface.CreateLegacyFont(fontfamily, 128 + fontsizeadd3D, fontweight3D, true, false, "ZS3D2DFont2BigBlur", false, false, 16)

	surface.CreateLegacyFont(fontfamilysm, 14 + fontsizeadd3D, fontweightbody, true, false,  "ZS3D2DUnstyleTiny", true, false)
	surface.CreateLegacyFont(fontfamilysm, 24 + fontsizeadd3D, fontweightbody, true, false,  "ZS3D2DUnstyleSmallest", true, false)
	surface.CreateLegacyFont(fontfamilysm, 36 + fontsizeadd3D, fontweightbody, true, false,  "ZS3D2DUnstyleSmaller", true, false)
end

function GM:CreateNonScaleFonts()
	surface.CreateLegacyFont(fontfamily, 96, 500, true, false, "zshintfont", true, false)

	surface.CreateFont("DefaultFontVerySmall", {font = fontfamily, size = 10, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultFontSmall", {font = fontfamily, size = 11, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultFontSmallDropShadow", {font = fontfamily, size = 11, weight = 400, shadow = true, antialias = true, extended = true})
	surface.CreateFont("DefaultFont", {font = fontfamily, size = 13, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultFontAA", {font = fontfamily, size = 13, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultFontBold", {font = fontfamily, size = 13, weight = 700, antialias = true, extended = true})
	surface.CreateFont("DefaultFontLarge", {font = fontfamily, size = 16, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultFontLargeAA", {font = fontfamily, size = 16, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultFontLargest", {font = fontfamily, size = 22, weight = 500, antialias = true, extended = true})
	surface.CreateFont("DefaultFontLargestAA", {font = fontfamily, size = 22, weight = 500, antialias = true, extended = true})

	surface.CreateFont("DermaDefault", {font = fontfamily, size = 13, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DermaDefaultBold", {font = fontfamily, size = 13, weight = 700, antialias = true, extended = true})
	surface.CreateFont("DermaLarge", {font = fontfamily, size = 32, weight = 500, antialias = true, extended = true})
	surface.CreateFont("Default", {font = fontfamily, size = 13, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultBold", {font = fontfamily, size = 13, weight = 700, antialias = true, extended = true})
	surface.CreateFont("DefaultSmall", {font = fontfamily, size = 11, weight = 400, antialias = true, extended = true})
	surface.CreateFont("DefaultLarge", {font = fontfamily, size = 16, weight = 400, antialias = true, extended = true})
	surface.CreateFont("Trebuchet18", {font = fontfamily, size = 18, weight = 400, antialias = true, extended = true})
	surface.CreateFont("Trebuchet24", {font = fontfamily, size = 24, weight = 500, antialias = true, extended = true})
end
...
function GM:CreateScalingFonts()
	...
	surface.CreateLegacyFont(fontfamily, liscreenscale * (32 + fontsizeadd), fontweight, true, false, "ZSScoreBoardTitle", true, false)
	surface.CreateLegacyFont(fontfamily, liscreenscale * (22 + fontsizeadd), fontweight, true, false, "ZSScoreBoardSubTitle", true, false)
	surface.CreateLegacyFont(fontfamily, liscreenscale * (16 + fontsizeadd), fontweight, true, false, "ZSScoreBoardPlayer", true, false)
	surface.CreateLegacyFont(fontfamily, liscreenscale * (24 + fontsizeadd), fontweight, true, false, "ZSScoreBoardHeading", false, false)
	surface.CreateLegacyFont(fontfamily, 18 * liscreenscale, fontweightbody, true, false, "ZSScoreBoardPlayerSmall", true, false)
	surface.CreateLegacyFont(fontfamily, 15 * liscreenscale, fontweightbody, true, false, "ZSScoreBoardPlayerSmaller", true, false)
	surface.CreateLegacyFont(fontfamily, 11 * liscreenscale, fontweightbody, true, false, "ZSScoreBoardPing")
	...
	surface.CreateLegacyFont(fontfamilysm, screenscale * 13, fontweightbody, fontaa, false, "ZSBodyTextFontSmall", fontshadow)

	surface.CreateLegacyFont(fontfamilysm, screenscale * 15, fontweightbody, fontaa, false, "ZSBodyTextFont", fontshadow, false)
	surface.CreateLegacyFont(fontfamilysm, screenscale * 20, fontweightbody, fontaa, false, "ZSBodyTextFontBig", fontshadow, false)

	surface.CreateLegacyFont(fontfamily, screenscale * (20 + fontsizeadd), fontweight, true, false, "ZSDamageResistance", true, false)
	surface.CreateLegacyFont(fontfamily, screenscale * (20 + fontsizeadd), fontweight, true, false, "ZSDamageResistanceBlur", false, false, 8)

	surface.CreateFont("ZSXPBar", {font = fontfamily, size = screenscale * 14, weight = 400, antialias = true, shadow = true, extended = true})
end
...
function GM:PrecacheKillicons()
	local fonts, mats = {}, {}

	local function add(class)
		if not class then return end
		local kitbl = killicon.Get(class)
		if not kitbl then return end
		if #kitbl == 3 then
			local char = kitbl[2]
			fonts[kitbl[1] .. "\0" .. char] = {kitbl[1], char}
			fonts[kitbl[1] .. "pa\0" .. char] = {kitbl[1] .. "pa", char}
		elseif #kitbl == 2 and kitbl[1] then
			mats[kitbl[1]] = true
			Material(kitbl[1])
		end
	end
	...
	for _, tab in ipairs(self.Items or {}) do
		add(self.ZSInventoryItemData and self.ZSInventoryItemData[tab.SWEP] and "weapon_zs_craftables" or tab.SWEP or tab.Model)
	end

	self.KilliconPrecacheFonts = fonts
	self.KilliconPrecacheMats = mats
	self.KilliconPrecacheLeft = 3
end

hook.Add("HUDPaint", "RelapsePrecacheKillicons", function()
	local gm = GAMEMODE
	if not gm or (gm.KilliconPrecacheLeft or 0) <= 0 then return end
	gm.KilliconPrecacheLeft = gm.KilliconPrecacheLeft - 1

	surface.SetTextColor(255, 255, 255, 255)
	for _, pair in pairs(gm.KilliconPrecacheFonts or {}) do
		surface.SetFont(pair[1])
		surface.SetTextPos(-2048, -2048)
		surface.DrawText(pair[2])
	end

	surface.SetDrawColor(255, 255, 255, 255)
	for path in pairs(gm.KilliconPrecacheMats or {}) do
		local mat = Material(path)
		if mat and not mat:IsError() then
			surface.SetMaterial(mat)
			surface.DrawTexturedRect(-64, -64, 32, 32)
		end
	end
end)
...
function GM:CreateVGUI()
	...
	self.GameStatePanel:InvalidateLayout()
...
function GM:_CalcView(pl, origin, angles, fov, znear, zfar)
	...
	if self.Stride and self.Stride.ApplyCamera and not pl:ShouldDrawLocalPlayer() then
		self.Stride:ZeroEngineBob(pl)
		origin, angles = self.Stride:ApplyCamera(pl, origin, angles)
	end
...
function GM:PlayerStepSoundTime(pl, iType, bWalking)
	...
	if self.Stride and self.Stride:UsesStride(pl) then
		return self.Stride:GetStepSoundTime(pl, iType, bWalking)
	end

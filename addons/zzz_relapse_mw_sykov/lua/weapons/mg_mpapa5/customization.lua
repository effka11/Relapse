...
function SWEP:doCalConversionStats()
    ...
    -- Relapse: attachment conversions do not change the cartridge id.
    end
end
...
SWEP.Customization = {
    ...
    {"attachment_vm_sm_mpapa5_barrel", "attachment_vm_sm_mpapa5_barrel_noflash", "attachment_vm_sm_mpapa5_barshort", 
    "attachment_vm_sm_mpapa5_railgrip",
    ...
    {"att_grip", "attachment_vm_sm_mpapa5_bipodgrip", "attachment_vm_sm_mpapa5_angledgrip01", "attachment_vm_sm_mpapa5_angledgrip02", "attachment_vm_sm_mpapa5_stubbygrip01", 

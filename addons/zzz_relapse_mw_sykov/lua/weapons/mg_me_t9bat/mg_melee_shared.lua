...
-- Melee camera bone is 1:1 on the eye. Scale only slash/heavy tasks so walk
-- and sprint from the same bone stay at full MW.
if CLIENT then
	...
	function SWEP:CalcView(ply, pos, ang, fov)
		...
		if not IsMeleeCameraTask(self) then
			return p, a, f
		end

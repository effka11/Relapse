...
if CLIENT then
	killicon.Add("mg_me_t9bat", "zombiesurvival/killicons/weapon_zs_cwbat2.png", Color(255, 255, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("zombiesurvival/killicons/weapon_zs_cwbat2.png")
end

SWEP.RelapsePreviewIcon = "zombiesurvival/killicons/weapon_zs_cwbat2.png"
-- WM already has the bat mesh (shaft along +Z). No default attachments.
...
-- Same family as the cane: shaft +Z. 45 around the handle lays the stick
-- on the card; the barrel stays on the +X end.
...
SWEP.PrintName = "Бита"
SWEP.Description = "A baseball bat. Wood, not an edge: it reaches the one in the doorway, not the one behind him."
SWEP.TranslationName = "wep_cwbat"
SWEP.TranslationDescription = "wep_cwbat_desc"
SWEP.Category = "Black Ops: Cold War"
SWEP.SubCategory = "Melees"
SWEP.Spawnable = true
SWEP.VModel = Model("models/easy/cw/weapons/vm_me_t9bat.mdl")
SWEP.WorldModel = Model("models/easy/cw/weapons/wm_me_t9bat.mdl")
SWEP.Purpose = "A baseball bat. Wood, not an edge: it reaches the one in the doorway, not the one behind him."
...
-- Stopping is knockback. Range is hull trace hu. Weight is kilograms (wood bat ~0.90 kg).
-- Seven hits on 225, not CoD 50. Longer blunt than the kit knife: the doorway, not the cane's wait.
SWEP.Relapse = {
	Melee = true,
	Type = "blunt",
	Damage = 33,
...
SWEP.MeleeSounds = {
	Flesh = "weap_baseballbat_hit_flesh",
	Cement = "weap_baseballbat_hit",
	Metal = "weap_baseballbat_hit",
	Soft = "weap_baseballbat_hit",
	Wood = "weap_baseballbat_hit",
}

...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("weap_sierrax_sup_plr")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    {"att_perk", "attachment_vm_lm_sierrax_perk_soh", "att_perk_fmj", "att_perk_ricochet", "att_perk_headshot"}, 

    {"attachment_vm_lm_sierrax_stock", "attachment_vm_lm_sierrax_stockh", 
    "attachment_vm_lm_sierrax_stockl", "attachment_vm_lm_sierrax_stockno", "attachment_vm_lm_sierrax_stocksaw"},

    {"attachment_vm_lm_sierrax_mag", "attachment_vm_lm_sierrax_xmags", 
    "attachment_vm_lm_sierrax_magcalcust1", "attachment_vm_lm_sierrax_magcalcust2"},

    {"attachment_vm_lm_sierrax_barrel", "attachment_vm_lm_sierrax_barlight", 
    "attachment_vm_lm_sierrax_barlong", "attachment_vm_lm_sierrax_barhvy"},
    ...
    {"att_laser", "attachment_vm_lm_sierrax_laser01", "attachment_vm_lm_sierrax_laser02", 
    "attachment_vm_lm_sierrax_laser03"},

    {"att_grip", "attachment_vm_lm_sierrax_angledgrip01", "attachment_vm_lm_sierrax_angledgrip02", "attachment_vm_lm_sierrax_stubbygrip01", 
    "attachment_vm_lm_sierrax_stubbygrip02", "attachment_vm_lm_sierrax_vertgrip01", "attachment_vm_lm_sierrax_vertgrip02", 
    "attachment_vm_lm_sierrax_vertgrip03"},
}
...
--         Slot = 2,
--         {
--             Key = "attachment_vm_lm_sierrax_barrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 0
--             },
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_custombarrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 4
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_lmgbarrel_grip",
--             Bodygroups = {
--                 ["barrel_handguard"] = 4
--             },
--             ExcludedAttachments = {
...
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_lmgbarrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 0
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_smgbarrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 2,
--                 ["tag_tip"] = 1
--             },
...
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_smgbarcust",
--             Bodygroups = {
--                 ["barrel_handguard"] = 4
--             },
--             ExcludedAttachments = {
...
--         Slot = 7,
--         {
--             Key = "attachment_vm_lm_sierrax_stock",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_lmgstock",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_smgstock_unfolded",
--             Bodygroups = {
--                 ["stock_adapter"] = 1
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_smgstock",
--             ExcludedAttachments = {
--                 ["Magazine"] = {4}
--             },
--             Bodygroups = {
...
--         },
    --     {
    --         Key = "attachment_vm_lm_sierrax_stockno",
    --         Bodygroups = {
    --             ["stock_adapter"] = 1
    --         },
    --         Stats = function(self)
...
--         Slot = 5,
--         {
--             Key = "attachment_vm_lm_sierrax_mag",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_xmags",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_smgmag",
--             Stats = function(self)
--                 doSmgStats(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_sierrax_drum_mag",
--             Stats = function(self)
--             end
--         }
--     },

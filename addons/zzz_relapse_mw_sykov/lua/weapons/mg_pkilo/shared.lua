...
if CLIENT then
    killicon.Add("mg_pkilo", "zombiesurvival/killicons/weapon_zs_pkm_side2.png", Color(255, 255, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("zombiesurvival/killicons/weapon_zs_pkm_side2.png")
end

SWEP.RelapsePreviewIcon = "zombiesurvival/killicons/weapon_zs_pkm_side2.png"

...
if CLIENT then
	killicon.Add("mg_me_t9sledgehammer", "zombiesurvival/killicons/weapon_zs_cwsledge2.png", Color(255, 255, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("zombiesurvival/killicons/weapon_zs_cwsledge2.png")
end

SWEP.RelapsePreviewIcon = "zombiesurvival/killicons/weapon_zs_cwsledge2.png"
-- WM already has the hammer mesh (shaft along +Z, head +X). No default attachments.
...
-- on the card; the head stays on the +X end.
...
SWEP.Description = "A sledgehammer. Steel, not an edge: it drops the one behind the doorway, not the one in the next room."
SWEP.TranslationName = "wep_cwsledge"
SWEP.TranslationDescription = "wep_cwsledge_desc"
...
SWEP.Purpose = "A sledgehammer. Steel, not an edge: it drops the one behind the doorway, not the one in the next room."

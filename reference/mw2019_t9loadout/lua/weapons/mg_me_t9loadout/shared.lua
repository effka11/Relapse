...
if CLIENT then
	killicon.Add( "mg_me_t9loadout", "VGUI/entities/mg_me_t9loadout", Color(255, 0, 0, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_me_t9loadout")
end
...
SWEP.Purpose = "Lethal melee weapon. Military-issue combat knife with a straight-edge blade that kills enemies with a single deadly strike. Trusted by the U.S. Military since the early 40's."

...
if CLIENT then
	killicon.Add( "mg_me_t9cane", "VGUI/entities/mg_me_t9cane", Color(255, 0, 0, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_me_t9cane")
end
...
SWEP.Purpose = "Lethal walking cane. Where fashion meets function. Adorned with a sterling silver handle, this cane is easy to grip and deadly when swung."
...
SWEP.Bullet = {
	Damage = {65, 65}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range

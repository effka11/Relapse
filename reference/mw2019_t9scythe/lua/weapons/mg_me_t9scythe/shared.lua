...
if CLIENT then
	killicon.Add( "mg_me_t9scythe", "VGUI/entities/mg_me_t9scythe", Color(255, 0, 0, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_me_t9scythe")
end
...
SWEP.Purpose = "Two-handed melee. Reap a bountiful harvest by cutting down all who stand in your path. Quick swinging with a wide arc for deadly efficiency."

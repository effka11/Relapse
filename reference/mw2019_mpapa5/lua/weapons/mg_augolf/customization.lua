...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("weap_augolf_fire_plr_sup")
    ...
    self.Primary.Sound = Sound("weap_augolf_cal_plr_sup")
    end
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
...
function SWEP:doCalConversionStats()
    ...
    if (!bSup1 && !bSup2 && !bSup3 && !bSup4 && !bSup5 && !bSup6) then
        self.Primary.Sound = Sound("weap_augolf_cal_plr")
        self.Reverb = {
            RoomScale = 50000,
            Sounds = {
                Outside = {
...
SWEP.Customization = {
    ...
    {"att_grip", "attachment_vm_sm_augolf_bipodgrip", "attachment_vm_sm_augolf_angledgrip01", "attachment_vm_sm_augolf_angledgrip02", "attachment_vm_sm_augolf_stubbygrip01", 

...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("weap_papa90_sup_fire_plr_lfe")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    ...
    {"att_sight", "att_vm_2x_west02_holo", "att_vm_2x_west02", "att_vm_reflex_02", "att_vm_minireddot01_tall", "attachment_vm_sm_papa90_reddotscope", 
    "att_vm_minireddot02_tall", "att_vm_minireddot03_tall",

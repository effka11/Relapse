...
SWEP.Trigger = {
    PressedSound = Sound("weap_mpapa7_fire_first_plr"),
    ReleasedSound = Sound("weap_mpapa7_disconnector_plr"),
    Time = 0
}

SWEP.Primary.Sound = Sound("weap_mpapa7_fire_plr_lfe")
...
SWEP.Recoil = {
    Vertical = {1, 1.25}, --random value between the 2
    Horizontal = {-0.6, 0.8}, --random value between the 2

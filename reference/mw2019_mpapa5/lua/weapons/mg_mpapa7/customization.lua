...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("weap_mpapa7_fire_plr_sup")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    ...
    {"attachment_vm_sm_mpapa7_receiver"},
    ...
    {"att_grip", "attachment_vm_sm_mpapa7_bipodgrip", "attachment_vm_sm_mpapa7_angledgrip01", "attachment_vm_sm_mpapa7_angledgrip02", "attachment_vm_sm_mpapa7_stubbygrip01", 

...
SWEP.HoldType = "Rifle"
SWEP.Trigger = {
    PressedSound = Sound("weap_beta_fire_first_plr"),
    ReleasedSound = Sound("weap_beta_disconnector_plr"),
    Time = 0
}

SWEP.Primary.Sound = Sound("weap_beta_fire_plr_lfe")
SWEP.Primary.Ammo = "SMG1"
SWEP.Primary.ClipSize = 64
SWEP.Primary.Automatic = true
SWEP.Primary.BurstRounds = 1
SWEP.Primary.BurstDelay = 0
SWEP.Primary.RPM = 654
SWEP.CanChamberRound = true  
  
SWEP.ParticleEffects = {
    ["MuzzleFlash"] = "mwb_muzzle_smg_2",
...
SWEP.Recoil = {
    Vertical = {0.2, 0.25}, --random value between the 2
    Horizontal = {-0.15, 0.25}, --random value between the 2

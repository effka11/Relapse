...
SWEP.Customization = {
    ...
    {"attachment_vm_ar_akilo47_stock", "attachment_vm_ar_akilo47_smgstock_unfolded",
    "attachment_vm_ar_akilo47_smgstock", "att_vm_stock_heavy01", 
    "att_vm_stock_heavy02", "att_vm_stock_light01", "att_vm_stock_medium01", "att_vm_stock_no", "att_vm_ar_akilo47_lmgstock"},

    {"attachment_vm_ar_akilo47_mag", "attachment_vm_ar_akilo47_45r",
    "attachment_vm_ar_akilo47_smgmag", 
    "attachment_vm_ar_akilo47_xmags", "attachment_vm_ar_akilo47_drum_mag"},

    {"attachment_vm_ar_akilo47_barrel",
    ...
    {"att_sight", "attachment_vm_ar_akilo47_scope", "att_vm_2x_west02_holo", "att_vm_2x_west02", "att_vm_reflex_02", "attachment_vm_ar_akilo47_rail", "att_vm_minireddot01_tall", "att_vm_minireddot02_tall", "att_vm_minireddot03_tall",
    ...
    "attachment_vm_ar_akilo47_vertgrip03", "attachment_vm_ar_akilo47_bipodgrip"},
}

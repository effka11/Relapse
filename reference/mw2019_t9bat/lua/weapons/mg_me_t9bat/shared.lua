...
if CLIENT then
	killicon.Add( "mg_me_t9bat", "VGUI/entities/mg_me_t9bat", Color(255, 0, 0, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_me_t9bat")
end
...
SWEP.Purpose = "Lethal sporting equipment. Lightweight bat with a cork center. Swing for the fences knock your enemies out of the park."
...
SWEP.Bullet = {
	Damage = {50, 50}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range

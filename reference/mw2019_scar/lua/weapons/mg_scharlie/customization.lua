...
SWEP.Customization = {
    {"att_perk", "attachment_vm_ar_scharlie_perk_soh", "att_perk_fmj", "att_perk_ricochet", "att_perk_headshot"}, 

    {"att_receiver"}, 

    {"attachment_vm_ar_scharlie_barrel", "attachment_vm_ar_scharlie_barrel_pdw", "attachment_vm_ar_scharlie_barrel_mid", "attachment_vm_ar_scharlie_barrel_long"},

    {"attachment_vm_ar_scharlie_mag", "attachment_vm_ar_scharlie_mag_dmr", "attachment_vm_ar_scharlie_mmags", "attachment_vm_ar_scharlie_xmags"},

    {"attachment_vm_ar_scharlie_stock", "attachment_vm_ar_scharlie_stock_light", "attachment_vm_ar_scharlie_stock_dmr", "att_vm_stock_heavy01", 
    ...
    {"att_grip", "attachment_vm_ar_scharlie_bipodgrip", "attachment_vm_ar_scharlie_angledgrip01", "attachment_vm_ar_scharlie_angledgrip02", "attachment_vm_ar_scharlie_stubbygrip01", 

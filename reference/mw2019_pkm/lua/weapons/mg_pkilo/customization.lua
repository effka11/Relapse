...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("weap_pkilo_sup_plr")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    {"att_perk", "attachment_vm_lm_pkilo_perk_soh", "att_perk_fmj", "att_perk_ricochet", "att_perk_headshot"}, 

    {"attachment_vm_lm_pkilo_stock", "att_vm_stock_heavy01", 
    "att_vm_stock_heavy02", "att_vm_stock_light01", "att_vm_stock_medium01", "att_vm_stock_no"},

    {"attachment_vm_lm_pkilo_mag", "attachment_vm_lm_pkilo_mag_xlrg", "attachment_vm_lm_pkilo_mag_ext"},

    {"attachment_vm_lm_pkilo_barrel", "attachment_vm_lm_pkilo_barrel_short", "attachment_vm_lm_pkilo_barrel_heavy", "attachment_vm_lm_pkilo_barrel_long"},
    ...
    {"att_laser", "attachment_vm_lm_pkilo_laser01_cylinder", "attachment_vm_lm_pkilo_laser02_cylinder", 
    "attachment_vm_lm_pkilo_laser03_cylinder"},

    {"att_grip", "attachment_vm_lm_pkilo_angledgrip01", "attachment_vm_lm_pkilo_angledgrip02", "attachment_vm_lm_pkilo_stubbygrip01", 
    "attachment_vm_lm_pkilo_stubbygrip02", "attachment_vm_lm_pkilo_vertgrip01", "attachment_vm_lm_pkilo_vertgrip02", 
    "attachment_vm_lm_pkilo_vertgrip03", "attachment_vm_lm_pkilo_bipod"},
}
...
--         Slot = 2,
--         {
--             Key = "attachment_vm_lm_pkilo_barrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 0
--             },
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_custombarrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 4
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_lmgbarrel_grip",
--             Bodygroups = {
--                 ["barrel_handguard"] = 4
--             },
--             ExcludedAttachments = {
...
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_lmgbarrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 0
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_smgbarrel",
--             Bodygroups = {
--                 ["barrel_handguard"] = 2,
--                 ["tag_tip"] = 1
--             },
...
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_smgbarcust",
--             Bodygroups = {
--                 ["barrel_handguard"] = 4
--             },
--             ExcludedAttachments = {
...
--         Slot = 7,
--         {
--             Key = "attachment_vm_lm_pkilo_stock",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_lmgstock",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_smgstock_unfolded",
--             Bodygroups = {
--                 ["stock_adapter"] = 1
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_smgstock",
--             ExcludedAttachments = {
--                 ["Magazine"] = {4}
--             },
--             Bodygroups = {
...
--         },
    --     {
    --         Key = "attachment_vm_lm_pkilo_stockno",
    --         Bodygroups = {
    --             ["stock_adapter"] = 1
    --         },
    --         Stats = function(self)
...
--         Slot = 5,
--         {
--             Key = "attachment_vm_lm_pkilo_mag",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_xmags",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_smgmag",
--             Stats = function(self)
--                 doSmgStats(self)
--             end
--         },
--         {
--             Key = "attachment_vm_lm_pkilo_drum_mag",
--             Stats = function(self)
--             end
--         }
--     },

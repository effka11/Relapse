...
SWEP.Cone = {
    ...
    Increase = 0.045, --increase cone size by this amount every time we shoot
...
SWEP.Recoil = {
    Vertical = {2, 2.25}, --random value between the 2
    Horizontal = {-1.4, 1.4}, --random value between the 2

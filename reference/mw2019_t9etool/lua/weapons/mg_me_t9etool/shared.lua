...
if CLIENT then
	killicon.Add( "mg_me_t9etool", "VGUI/entities/mg_me_t9etool", Color(255, 0, 0, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_me_t9etool")
end
...
SWEP.Purpose = "Lightweight entrenching shovel effective in close quarters combat. Offers enhanced mobility."
...
SWEP.Bullet = {
	Damage = {40, 40}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range

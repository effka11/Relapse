...
if CLIENT then
    killicon.Add( "mg_sbeta", "VGUI/entities/mg_sbeta", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_sn_sbeta")
end
...
SWEP.Bullet = {
    Damage = {92, 50}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range

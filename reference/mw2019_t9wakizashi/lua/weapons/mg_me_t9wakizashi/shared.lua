...
if CLIENT then
	killicon.Add( "mg_me_t9wakizashi", "VGUI/entities/mg_me_t9wakizashi", Color(255, 0, 0, 255))
	SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_me_t9wakizashi")
end
...
SWEP.Purpose = "Famously known as the companion sword to the Samurai's Katana. Traditionally forged using a folded steel technique. Light to wield, resilient to force, and durable to wear."
...
SWEP.Bullet = {
	Damage = {75, 75}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range
